...
project = u'DOCSIS'
copyright = u'2017-2020 Cable Television Laboratories, Inc.'
...
latex_documents = [
  ('index', 'docsis-ns3-documentation.tex', u'The ns-3 DOCSIS® Module Documentation', u'CableLabs', 'manual'),
]
...
man_pages = [
    ('index', 'ns-3-docsis-module', u'ns-3 DOCSIS Module',
     [u'CableLabs'], 1)
]
