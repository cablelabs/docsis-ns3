...
DocsisScenarioHelper::CreateBasicNetwork (void)
{
  ...
  Ptr<Ipv4Interface> iface2 = ifacePair2.first->GetObject<Ipv4L3Protocol> ()->GetInterface (ifacePair2.second);
  ...
  Ptr<Ipv4Interface> iface3 = ifacePair3.first->GetObject<Ipv4L3Protocol> ()->GetInterface (ifacePair3.second);
...
Ptr<CmNetDevice>
DocsisScenarioHelper::GetCmNetDevice (void) const
{
...
Ptr<CmtsNetDevice>
DocsisScenarioHelper::GetCmtsNetDevice (void) const
{
...
DocsisScenarioHelper::GetUpstreamDualQueue (void) const
{
  return m_upstreamDualQueue;
}

Ptr<DualQueueCoupledAqm>
DocsisScenarioHelper::GetDownstreamDualQueue (void) const
{
  return m_downstreamDualQueue;
}

Ptr<QueueProtection>
DocsisScenarioHelper::GetUpstreamQueueProtection (void) const
{
  return m_upstreamDualQueue->GetQueueProtection ();
}

Ptr<QueueProtection>
DocsisScenarioHelper::GetDownstreamQueueProtection (void) const
{
...
{
  NS_LOG_FUNCTION (this);
  m_docsisDevices.Get (1)->GetObject<CmNetDevice> ()->TraceConnectWithoutContext ("ClassicSojournTime", cb);
}
